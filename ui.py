...
class QuizInterface:
  ...
  def __init__(self, quiz_brain: QuizBrain):
    ...
    # Access the next question from Quizbrain
    self.get_next_questions()

    # Acts as a never ending while looping (checking to see if there's new interaction). It will get confused with another while loop
